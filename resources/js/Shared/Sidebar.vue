            ...
            <ul class="sidebar-menu scrollable pos-r">
                ...
                <li class="nav-item" >
                    <Link class="sidebar-link" href="/prices"
                        ...
                        ><span class="title">Prices</span></Link
                    >
                </li>
                ...
                <li class="nav-item" v-if="$page.props.auth.user.role == 'PGO' || $page.props.auth.user.role == 'Admin'">
                    <Link class="sidebar-link" href="/projects"
                        ...
                        ><span class="title">Projects</span></Link
                    >
                </li>
                <li class="nav-item">
