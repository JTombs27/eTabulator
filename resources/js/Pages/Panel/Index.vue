            ...
            <div class="tabl-responsive bgc-white p-20 bd shadow-sm">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr v-if="criteria_list.data <= 0"><td class="text-center text-danger"  colspan="6">No Set of Criteria for Judging!</td></tr>
                    </tbody>
                </table>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end" v-if="criteria_list.data.length >= 1">
                        <Label>{{ criteria_list.data[0]["total_percentage"] }}</Label>
                    </div>
                </div>
            </div>
        </div>
  ...
  mounted()
    ...
    methods:
    {
        ...
        saveCriteria()
        {
            this.form.event_id  = this.filterData.event_id;
            this.form.settup_id = this.filterData.settup_id;
            var action_route = this.actionMode == "Add" ? '/panel/save-all-criteria': '/panel/update';
