    ...
    <div class="row gap-10 masonry pos-r">
        <div class="col-lg-12">
            <div class="peers fxw-nw jc-sb ai-c">
                <h3><b>List of  Participants</b></h3>
                <div class="peers">
        ...
        <div class="col-md-12 ">
                <div class="col-md-12 bgc-white p-10 bd shadow-sm">
                    <div class="row mT-5">
                        ...
                        <div class="col-md-4">
                            <Select2 v-model="filterData.event_id" :options="event" @select="ddl_eventchange($event)" />
                        </div>
                        <div class="col-md-1">
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-1 text-center">
                                        <img class="cover bdrs-50p" style="width:50px;height: 50px;"   :src="`/storage/${eventX.participants_profile}`" alt=""/>
                                    </div>
                                    <div class="col-md-4">
                                        <table>
                                            <tr>
                                    ...
                                    <div class="col-md-1">
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            <button type="button" @click="editRowClick(eventX.id)" class="btn btn-outline-primary btn-sm">
...
export default {
  ...
  mounted()
    ...
    methods:
    {
        ...
        editRowClick(par_id)
        {   
            this.filterData.id = par_id
                this.$inertia.get('/event-participants/edit',  this.filterData);
        },
        createClick()
        {
            if(this.filterData.settup_id == "" || this.filterData.settup_id == null)
            {
                alert("Please Select All the required filter!");
            }
            else
            {
