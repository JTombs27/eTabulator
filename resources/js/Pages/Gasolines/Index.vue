    ...
    <div class="row gap-10 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            ...
            <div class="peers">
                ...
                <div class="peer"  v-if="can.canCreateGasoline">
                    <Link class="btn btn-primary btn-sm" href="/gasolines/create">Add Station</Link>
        ...
        <div class="col-12">
            <div class="tabel-responsive bgc-white p-20 bd shadow-sm">
                            ...
                            <td style="text-align: right" v-if="can.canEditGasoline || can.canDeleteGasoline">
                                ...
                                <div class="dropdown dropstart">
                                  ...
                                  <ul class="dropdown-menu action-dropdown" aria-labelledby="dropdownMenuButton1">
                                    <li v-if="can.canEditGasoline">
                                        <Link class="dropdown-item" title="Edit Station!" @click="editStation(gasolines.id)"> 
                                    ...
                                    <li v-if="can.canDeleteGasoline">
                                        <button class="dropdown-item" title="Delete"  @click="deleteStation(gasolines.id)" :disabled="gasolines.travel.length !== 0">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <pagination :next="gasoline.next_page_url" :prev="gasoline.prev_page_url" />
                    </div>
                </div>
            </div>
        </div>
